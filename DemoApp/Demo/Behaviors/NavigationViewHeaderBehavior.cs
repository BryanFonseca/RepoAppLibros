...
namespace Demo.Behaviors
{
    public class NavigationViewHeaderBehavior : Behavior<WinUI.NavigationView>
    {
        ...
        private void OnNavigated(object sender, NavigationEventArgs e)
        {
            ...
            {
                MainPage.textoUser.Text = "Trabajador";
            }
            else
            {
                MainPage.textoUser.Text = "Administrador";
            }
            if (SingletonUsuarios.Instance.conectado)
            {
                MainPage.PanLogin.Visibility = Visibility.Collapsed;
                MainPage.CerrarBoton.Visibility = Visibility.Visible;
                MainPage.imageAdmin.Visibility = Windows.UI.Xaml.Visibility.Visible;
                MainPage.textoUser.Visibility = Windows.UI.Xaml.Visibility.Visible;
            }
            else
            {
                MainPage.PanLogin.Visibility = Visibility.Visible;
                MainPage.CerrarBoton.Visibility = Visibility.Collapsed;
                MainPage.imageAdmin.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                MainPage.textoUser.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            }
        }
